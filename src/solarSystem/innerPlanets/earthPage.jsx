          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-2">
                ...
                <span className="text-white text-lg">12,742 km</span>
              </div>
              <div className="p-2">
                <span className="text-blue-300 font-bold block mb-1">Distance from Sun</span> 
                <span className="text-white text-lg">149.6 million km</span>
              </div>
              <div className="p-2">
                <span className="text-blue-300 font-bold block mb-1">Orbital Period</span> 
                <span className="text-white text-lg">365.25 days</span>
              </div>
              <div className="p-2">
                <span className="text-blue-300 font-bold block mb-1">Moons</span> 
                <span className="text-white text-lg">1 (The Moon)</span>
              </div>
            </div>
          </div>
        </div>
