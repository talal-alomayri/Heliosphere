...
import bgImg from '../../assets/images/planet-uranus-pixel.webp';
import iconImg from '../../assets/images/planet-uranus-alone-pixel.webp';
...
export default function UranusPage() {
  ...
  return (
    <div ref={containerRef} className="h-screen overflow-y-auto overflow-x-hidden md:overflow-hidden relative bg-black">
      <img src={bgImg} alt="URANUS Background" aria-hidden="true" className="fixed md:absolute inset-0 w-full h-full object-cover z-0 pointer-events-none" />
      <StarsBackground />
      {/* Mobile Back Button */}
      <button 
        onClick={() => navigate(-1)}
